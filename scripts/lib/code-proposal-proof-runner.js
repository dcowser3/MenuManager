...
function validateDelivery(value, correction, driverHash, deliveryIdentity) {
    if (!value || value.driver !== 'form-submit-v1' || !isDigest(driverHash)
        ...
        || !deliveryIdentity || value.source_manifest_sha256 !== deliveryIdentity.delivery_source_sha256
        ...
        || value.quill_version !== deliveryIdentity.quill_version) throw new Error(`Delivery evidence is incomplete for ${correction.correction_id}.`);
