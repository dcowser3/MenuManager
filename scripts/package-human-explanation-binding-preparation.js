...
const SOURCE_CLOSURE = [
    ...
    'scripts/run-source-bound-preflight-v2.js',
    ...
    'services/dashboard/__tests__/source-bound-preflight-closure.test.js',
    'services/dashboard/__tests__/human-explanation-binding-packaging.test.js',
    'services/dashboard/__fixtures__/review-learning/source-bound-preflight-v2.json',
