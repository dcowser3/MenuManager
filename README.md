...
- Basic AI Check deterministically bolds high-confidence dish-name prefixes in the reviewed menu HTML using the shared approved-dish extractor; uncertain or ambiguous rows are left unbolded, and the same bolded preview HTML is submitted into generated DOCX / handoff artifacts.
