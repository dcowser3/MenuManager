...
- The modification database baseline picker flags whether each approved baseline is the latest for its property/service period, prioritizes exact property/service matches when those fields are selected, and warns before review/submission when a newer or mismatched baseline exists.
