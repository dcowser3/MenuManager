...
- Approved menus appear at `/approved-menus` as a chef-facing lookup: choose a restaurant, optionally narrow by service period, then download a clean editable Word DOCX for the next menu change.
