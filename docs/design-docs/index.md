...
| [Review-learning B5-C2c1 proof runner](review-learning-b5-c2c1-proof-runner.md) | Implemented, credential-free boundary | Independent proof runner plus fixed B5-C2c2 Docker/Jest unit boundary for JS and TypeScript inventories; replay and delivery remain explicitly blocked until repository-owned drivers exist; no provider, live DB, approval, deployment, or activation |
