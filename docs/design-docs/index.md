...
| [Review-learning B5-C2c1 proof runner](review-learning-b5-c2c1-proof-runner.md) | Implemented, credential-free boundary | Independent proof runner plus fixed B5-C2c2 Docker launcher boundary; no provider, live DB, approval, deployment, or activation |
