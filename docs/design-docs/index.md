...
| [Review-learning B5-C2c1 proof runner](review-learning-b5-c2c1-proof-runner.md) | Implemented, credential-free boundary | Independent injected baseline/candidate tests, paired replays, B6-D1 outcomes, schema-v2 integrity and owner-bound attachment; fixed Docker launcher remains deferred |
