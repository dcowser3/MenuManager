...
| [Contextual Culinary Spelling](contextual-culinary-spelling.md) | Implemented | Bounded reviewer-confirmed typo correction plus approved-menu vocabulary and a visible non-blocking fallback |
