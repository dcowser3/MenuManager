...
const allergen_integrity_guard_1 = require("../lib/allergen-integrity-guard");
describe('guardCorrectedMenuAllergens', () => {
    ...
    test('restores every submitted allergen code when the AI removes the cluster', () => {
        const result = (0, allergen_integrity_guard_1.guardCorrectedMenuAllergens)('Truffle Mac, aged cheddar D,G 24', 'Truffle Mac, aged cheddar 24', [], legend);
    ...
    test('keeps AI-added codes while restoring any submitted code it removed', () => {
        const result = (0, allergen_integrity_guard_1.guardCorrectedMenuAllergens)('Prawn Toast, sesame D,G 18', 'Prawn Toast, sesame G,S 18', [], legend);
    ...
    test('preserves custom configured allergen codes', () => {
        const result = (0, allergen_integrity_guard_1.guardCorrectedMenuAllergens)('Miso Soup SY 12', 'Miso Soup 12', [], 'SY contains soy | D contains dairy');
    ...
    test('drops an AI recommendation whose explicit change pair removes a code', () => {
        ...
        const result = (0, allergen_integrity_guard_1.guardCorrectedMenuAllergens)('Truffle Mac, aged cheddar D,G 24', 'Truffle Mac, aged cheddar D,G 24', [suggestion], legend);
    ...
    test('fails closed to the submitted menu when rows cannot be aligned', () => {
        ...
        const result = (0, allergen_integrity_guard_1.guardCorrectedMenuAllergens)(original, 'Soup 12', [], legend);
