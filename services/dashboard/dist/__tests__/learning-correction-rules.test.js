...
describe('buildCorrectionRuleRecord', () => {
    it('defaults force_target_case to false and preserves an explicit true value', () => {
        ...
        expect((0, learning_correction_rules_1.buildCorrectionRuleRecord)(base, [])).toMatchObject({ force_target_case: false });
        expect((0, learning_correction_rules_1.buildCorrectionRuleRecord)({ ...base, force_target_case: true }, []))
