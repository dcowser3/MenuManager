...
const viewPath = path_1.default.resolve(__dirname, '../views/prompt-proposal.ejs');
function renderProposalView(overrides = {}) {
...
describe('prompt-proposal view', () => {
    ...
    test('renders per-rule pre/post activation evidence and highlights inactive candidates', () => {
            ...
            proposal: {
                ...
                eval_summary: {
                    ...
                    candidate_rule_activations: [
                        { rule_index: 0, rule_id: 'eval-candidate-rule-0', original_text: 'homemade', corrected_text: 'housemade', pre_ai_activations: 2, post_ai_activations: 0, replay_activations: 0, total_activations: 2, case_ids: ['case-1'] },
                        { rule_index: 1, rule_id: 'eval-candidate-rule-1', original_text: 'house -made', corrected_text: 'housemade', pre_ai_activations: 0, post_ai_activations: 0, replay_activations: 1, total_activations: 1, case_ids: [], correction_ids: ['correction-1'] },
                        { rule_index: 2, rule_id: 'eval-candidate-rule-2', original_text: 'unused', corrected_text: 'replacement', pre_ai_activations: 0, post_ai_activations: 0, replay_activations: 0, total_activations: 0, case_ids: [] },
                    ],
                },
            },
        });
        ...
        expect(html).toContain('Targeted replay');
        expect(html).toContain('Full-suite cases');
