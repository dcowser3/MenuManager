...
describe('guardAllergenAlphabetizationSuggestions', () => {
    it('drops false D,G to G,D alphabetization suggestions and restores corrected menu text', () => {
        ...
        const result = (0, allergen_suggestion_guard_1.guardAllergenAlphabetizationSuggestions)(correctedMenu, [
            {
                type: 'Allergen Code',
                confidence: 'medium',
                severity: 'normal',
    ...
    it('keeps valid G,D to D,G alphabetization suggestions', () => {
        ...
        const result = (0, allergen_suggestion_guard_1.guardAllergenAlphabetizationSuggestions)(correctedMenu, [suggestion]);
