...
test('opt-in causal browser delivery proof and identical-source negative', async () => {
    ...
    const sourcePaths = { quill: required[0], diff_core: required[1], redline_preview: required[2], form_submission: required[3] };
