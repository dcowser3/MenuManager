...
describe('user error reports', () => {
    ...
    describe('buildErrorReportEmail', () => {
        test('builds a subject and escaped html body', () => {
            ...
            const { subject, html } = buildErrorReportEmail(report, { hasScreenshot: true, dashboardUrl: 'http://localhost:3005' });
        ...
        test('explains a missing screenshot', () => {
            ...
            const { html } = buildErrorReportEmail(report, { hasScreenshot: false });
