...
test('producer attaches only exact approved artifact activation metadata', () => {
    ...
    const attached = attachApprovedActivationMetadata([{ change_type: 'superseding_policy', original_text: 'house-made', corrected_text: 'housemade', is_location_specific: true, location: 'Restaurant A', applies_to_menu_type: 'food' }], envelope)[0];
