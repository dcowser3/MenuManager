export type MenuTitleGuardResult = {
    correctedMenu: string;
    restored: boolean;
    originalTitleLine: string | null;
};

function isStandaloneMenuTitle(line: string): boolean {
 ...
 */
export function preserveLeadingMenuTitle(originalMenu: string, correctedMenu: string): MenuTitleGuardResult {
