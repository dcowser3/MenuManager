...
describe('formatting signals', () => {
    test('extracts leading bold prefixes from cleaned DOCX HTML', () => {
        const lines = (0, formatting_signals_1.htmlToRichTextLines)('<p><strong>Guacamole</strong> avocado &amp; lime</p>');
    ...
    test('flags when final approval restores bolding the submitter already had', () => {
        const signals = (0, formatting_signals_1.extractBoldFormattingSignals)({
